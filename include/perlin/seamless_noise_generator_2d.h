 ...
 *
 * @details Seamless noise is generated by mapping a four-dimensional Clifford torus to 2
 * dimensions.
 *
 * @tparam Gen    A four-dimensional noise generator, eg. perlin_noise_generator or
 ...
 */
template<class Gen, typename Gen::grid_coord_t Width, typename Gen::grid_coord_t Height>
